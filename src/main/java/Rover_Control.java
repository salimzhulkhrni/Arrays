...
public class Rover_Control {
    ...
    public int roverMove(String[] str, int n){
        ...
        return findRoverMove(str, n, matrix, 0, 0);
    }
    
    private int findRoverMove(String[] str, int n, int[][] matrix, int row, int col){
        ...
        for(String command : str){
            ...
            if(command.equals("DOWN")){
                ...
                if(boundaryCheck(matrix, row + 1, col))
                    row = row + 1;
            }
                ...
                if(boundaryCheck(matrix, row, col - 1))
                    col = col - 1;
            }
    ...
    private boolean boundaryCheck(int[][] matrix, int row, int col){
    ...
    public static void main(String args[]) {
        ...
        Rover_Control obj = new Rover_Control();
        
        String[] cmds = new String[]{"RIGHT", "UP", "DOWN", "LEFT", "DOWN", "DOWN"};
        int n = 4;
        
        System.out.println("res: " + (obj.roverMove(cmds, n) == 12));
